...
static SpriteResource sprite_table[SPRITE_COUNT] = {
    ...
    [SPRITE_DIFFICULTY_EASY_BUTTON]   = { "assets/sprites/button_easy.bmp", NULL},
    [SPRITE_DIFFICULTY_MEDIUM_BUTTON] = { "assets/sprites/button_medium.bmp", NULL},
    [SPRITE_DIFFICULTY_HARD_BUTTON]   = { "assets/sprites/button_hard.bmp", NULL},
    [SPRITE_SPECIAL_MODE_BUTTON]      = { "assets/sprites/button_special-mode.bmp", NULL}
};
